  ...
  return (
    <main className=" items-center justify-center px-28 pt-8 relative">
      ...
      <div className='flex w-full justify-center items-center fixed top-[calc(90vh)]'>
        ...
        <a href="https://github.com/timi-codes/bookware" target='_blank' className="flex justify-between justify-self-end	items-center bg-black bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-80  h-12 w-12 rounded-full px-4 ml-1.5 hover:opacity-90 cursor-pointer">
